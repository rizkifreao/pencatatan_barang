...
<body class="off-canvas-sidebar">
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="#pablo">CV.Berkat Tresna Abadi.</a>
      </div>
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('<?=base_url()?>/assets/img/goods.jpg'); background-size: cover; background-position: top center;">
          ...
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
            ...
            <!-- <form class="form" method="" action=""> -->
              <div class="card card-login card-hidden">
                ...
                <div class="card-body ">
                  <!-- <p class="card-description text-center">asd</p> -->
                  <p class="card-description text-center text-danger"><?php echo $message;?></p>
                  ...
                  <?= form_error('identity','<p class="text-danger ml-5">','</p>')?>
                  ...
                  <?= form_error('password','<p class="text-danger ml-5">','</p>')?>
